...
<head>
    ...
    <title>Cemara Task Digital Marketing</title>
    ...
    <style>
        ...
        .shadow-tree {
            ...
            width: 350px;
            height: 450px;
            background-image: url('Cemara_20250208_170111_0000.jpg');
...
<body class="flex items-center justify-center min-h-screen text-gray-300 relative">
    <div class="shadow-tree"></div>
    <div class="bg-gray-800 shadow-lg rounded-lg p-12 max-w-xl text-center relative z-10 bg-opacity-90">
        <img src="Cemara_20250208_170111_0000.jpg" alt="Profile Picture" class="w-36 h-36 mx-auto rounded-full border-2 border-gray-400">
